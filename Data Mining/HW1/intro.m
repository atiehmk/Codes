...
s = {1,2;3,4}                % Creates a 2x2 cell array with
                             % scalar entries
s = {1, 'f'; 'hello', [1,3]} % Creates a 2x2 cell array with
                             % defferent data types
s = {}                       % Empty cell array 

struct('Name', [], 'Age', [])% Creates a structure with two
                             % two fields: 'Name' and 'Age'
s = struct('Name', 'Leonid Sigal', ...
       'Age',  28)           % Creates a structure and initializes
                             % the fields to default values
s.Name                       % Reference the field of the structure
s.Name = 'Machel J. Black'   % Assign the value to the field
